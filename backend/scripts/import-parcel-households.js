...
async function importHouseholdsFromParcelFile(slumId, filePath) {
  try {
    // Connect to MongoDB
...
if (require.main === module) {
  ...
  if (args.length < 2) {
    console.log('Usage: node import-parcel-households.js <slumId> <filePath>');
    console.log('Example: node import-parcel-households.js 69 "../APIS/Slum\'s_HH_Data/Slum_69.js"');
    process.exit(1);
  }
  ...
  importHouseholdsFromParcelFile(slumId, filePath).catch(console.error);
}

module.exports = importHouseholdsFromParcelFile;